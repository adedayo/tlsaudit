...
//--introduced by dayo (made marshal public)
...
//--introduced by dayo
func (m *serverHelloMsg) Export() tlsmodel.ServerHelloMessage {
	return tlsmodel.ServerHelloMessage{
		Raw:                          m.raw,
		Vers:                         m.vers,
		Random:                       m.random,
...
//--introduced by dayo
func (m *certificateMsg) Export() tlsmodel.CertificateMessage {
	return tlsmodel.CertificateMessage{
		// Raw:          m.raw,
...
//--introduced by dayo
func (m *serverKeyExchangeMsg) Export() tlsmodel.ServerKeyExchangeMsg {
	return tlsmodel.ServerKeyExchangeMsg{
		Key: m.key,
		// Raw: m.raw,
	}
}
